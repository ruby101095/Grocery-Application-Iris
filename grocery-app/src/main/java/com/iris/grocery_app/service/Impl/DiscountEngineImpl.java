...
import com.iris.grocery_app.constant.DiscountExpressionConstants;
import com.iris.grocery_app.entity.Discount;
import com.iris.grocery_app.service.DiscountEngine;
...
public class DiscountEngineImpl implements DiscountEngine {
    ...
    public BigDecimal calculateItemLevel(
        ...
        context.setVariable(DiscountExpressionConstants.VAR_QUANTITY, quantity);
        context.setVariable(DiscountExpressionConstants.VAR_PRICE, price);
    ...
    public BigDecimal calculateCartLevel(
        ...
        StandardEvaluationContext context = new StandardEvaluationContext();
        context.setVariable(DiscountExpressionConstants.VAR_SUBTOTAL, subtotal);
